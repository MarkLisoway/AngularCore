...
namespace BusinessLogic
{
    ...
    public sealed class ServiceEndpoint
    {
        ...
        /// <TValidationModel>
        ///     ExecuteUpdate
        ///     <TValidationModel, TModel>
        ///         (TValidationModel validationModel)
        ///         where TValidationModel : IValidationModel
        ///         <TModel>
        ///             {
        ///             var validator = ModelValidationMappings.GetValidationMapping
        ///             <TValidationModel>
        ///                 ();
        ///                 var isValid = validator.ValidateUpdate(validationModel);
        ///                 if (!isValid) return ExecutionResult
        ///                 <TValidationModel>
